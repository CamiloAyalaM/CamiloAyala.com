...
export const skillCategories = [
  {
    category: 'Diseño & Comunicación',
    skills: ['Diseño Estratégico', 'UX/UI', 'Design Systems', 'Branding', 'Comunicación Digital', 'Personal Branding']
  },
  {
    category: 'Marketing & Datos',
    skills: ['Marketing Digital', 'SEO/SEM', 'CRM & Salesforce', 'Google Analytics', 'Copywriting', 'Contenido Editorial']
  },
  {
    category: 'Tecnología & Innovación',
    skills: ['Design Thinking', 'IA Aplicada', 'Diseño Generativo', 'Humanidades Digitales', 'Diseño Participativo', 'Web Design']
  },
  {
